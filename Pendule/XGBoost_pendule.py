...
###############################################################                                       
#Load data set
data = pd.read_excel('pendule_1.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('pendule_2.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('pendule_3.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('full_pendule.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('pendule_big.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('pendule_small.xlsx',index_col=False)
...
col=["Data pendule 1", "Data pendule 2", "Data pendule 3","Data gros pendule","Data  petit pendule"]
row=["Model pendule 1", "Model pendule 2", "Model pendule 3","Model FULL"]
