...
###############################################################                                       
#Load data set
data = pd.read_excel('racecar.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('limo.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('Xmaxx.xlsx',index_col=False)
...
###############################################################                                       
#Load data set
data = pd.read_excel('merged.xlsx',index_col=False)
...
print("")
data = [["X :"+str(round(MAPE_1_1,4))," "," "," "],
["Y :"+str(round(MAPE_1_1,4)), MAPE_2_1, MAPE_3_1,],
["theta :"+str(round(MAPE_1_1,4)), MAPE_2_1, MAPE_3_1,],
[MAPE_1_2, MAPE_2_2, MAPE_3_2,],
[MAPE_1_3, MAPE_2_3 , MAPE_3_3,],
[MAPE_1_F, MAPE_2_F , MAPE_3_F,MAPE_C_F]]

col=["Data Racecar", "Data Limo", "Data Xmaxx","Data Civic"]
row=[" ","Model Racecar"," ", "Model Limo", "Model Xmaxx","Model FULL (merged)"]
...
table = BT()
table.column_headers = ["Data Racecar", "Data Limo", "Data Xmaxx","Data Civic"]
table.append_row(['Model racecar',2,  2,  3])
...
#             CREATE AND TRAIN PHYSICAL MODELS                #
###############################################################
X_a1 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","pi6","X","Y","theta"],axis=1)
X_a1 = X_a1.values
...
X_a2 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","pi6","X","Y","theta"],axis=1)
X_a2 = X_a2.values
...
X_a3 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","pi6","X","Y","theta"],axis=1)
X_a3 = X_a3.values
...
X_aF = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","pi6","X","Y","theta"],axis=1)
X_aF = X_aF.values
...
X_aC = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","pi6","X","Y","theta"],axis=1)
X_aC = X_aC.values
...
#             CREATE AND TRAIN PHYSICAL MODELS                #
###############################################################
X_a1 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","X","Y","theta"],axis=1)
X_a1 = X_a1.values
...
X_a2 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","X","Y","theta"],axis=1)
X_a2 = X_a2.values
...
X_a3 = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","X","Y","theta"],axis=1)
X_a3 = X_a3.values
...
X_aF = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","X","Y","theta"],axis=1)
X_aF = X_aF.values
...
X_aC = data.drop(["v_i","l","a","delta","pi1","pi2","pi3","X","Y","theta"],axis=1)
X_aC = X_aC.values
